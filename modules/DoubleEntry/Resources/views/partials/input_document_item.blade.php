<el-popover
    ...
    <button type="button" class="relative absolute -top-2 left-3 flex items-center" slot="reference">
        <span class="text-xs text-purple border-b border-transparent transition-all hover:border-purple">
